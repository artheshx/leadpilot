      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-up animate-delay-200">
            <Link
              to="/contact"
              className="btn-shine group flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-xl text-base"
            >
            ...
            <Link
              to="/how-it-works"
              className="flex items-center gap-2 text-slate-300 hover:text-white border border-white/10 hover:border-white/20 hover:bg-white/5 px-8 py-4 rounded-xl transition-all text-base"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature) => (
              ...
              >
                <div className="w-10 h-10 chip-ring rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
          ...
          <div className="grid md:grid-cols-4 gap-6 relative">
            ...
            {steps.map((step, i) => (
              <div key={step.num} className="relative text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl chip-ring text-brand-300 font-bold text-xl mb-4 hover:scale-110 transition-transform">
                  {step.num}
                </div>
      ...
      <section className="py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <div key={t.name} className="glass card-lift rounded-2xl p-6 flex flex-col gap-4">
                {/* Stars */}
          ...
          <div className="glass rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/contact"
                  className="btn-shine group flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-xl"
                >
                  Start your campaign
                  <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                </Link>
